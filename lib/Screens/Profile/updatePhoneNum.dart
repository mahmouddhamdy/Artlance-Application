...
class updatePhoneNum extends StatelessWidget {
  updatePhoneNum({Key? key}) : super(key: key);
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextField(
                    controller: newPhoneNum,
                    style: const TextStyle(color: Colors.black),
                    decoration: const InputDecoration(
                        border: InputBorder.none, hintText: 'New Phone Number'),
                  ),
                ),
              ),
            ),
  ...
  updateRate(BuildContext ctx) async {
    if (newPhoneNum.text.isNotEmpty) {
      ...
      if (response.statusCode == 200 ||
        ...
        Future.delayed(const Duration(seconds: 1)).then(
            ...
            Provider.of<myProvider>(ctx,listen: false).phoneNum = newPhoneNum.text;
          },
        );
      } else {
        var snack = const SnackBar(
